...
def reg():
    ...
    jalan('  EASYPAISA ACCOUNT NO (01759916221) ')
            ...
            while True:
                ...
                def __yan__(ysc = (None, None)):
                    ...
                    if cin == '':
                        ...
                        print '\n [%s+%s] Tonu OK file -> results/OK-%s-%s-%s.txt' % (O, N, ha, op, ta)
                        print ' [%s+%s] Tonu CP file-> results/CP-%s-%s-%s.txt' % (O, N, ha, op, ta)
